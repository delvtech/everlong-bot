...
structs = {
    ...
    "IEverlongStrategy.EverlongPosition": IEverlongStrategy.EverlongPosition,
}
            ...
            "outputs": [
                {
                    "name": "",
                    "type": "tuple",
                    "internalType": "struct IEverlongStrategy.EverlongPosition",
                    "components": [
...
class IEverlongStrategyPositionAtContractFunction0(PypechainContractFunction):
    ...
    def call(
        ...
        """returns IEverlongStrategy.EverlongPosition."""
        # We handle the block identifier = None case here for typing.
        if block_identifier is None:
            block_identifier = self.w3.eth.default_block

        # Define the expected return types from the smart contract call
        return_types = IEverlongStrategy.EverlongPosition

        # Call the function
        raw_values = self._call(transaction, block_identifier, state_override, ccip_read_enabled)

        return cast(IEverlongStrategy.EverlongPosition, rename_returned_types(structs, return_types, raw_values))
